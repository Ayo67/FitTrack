...
class AppColors {
  ...
  static Color primaryColor = Color(0xffA8E6CF);
  static Color secondaryColor = Color(0xffFFD3B6);
  static Color bgColor = Color(0xffF9FAFB);
  static Color cardColor = Color(0xff171626);
